...
const products: Product[] = [
  ...
  },
  {
    ...
    description:
      "Property All Risks (PAR) adalah standar emas perlindungan aset komersial dan industri. Satu polis yang menutup hampir semua risiko yang tidak dikecualikan secara eksplistem — solusi ideal untuk kompleks ruko, mal, gedung perkantoran, hingga kawasan mixed-use di Greater Bekasi.",
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8">
        ...
        <circle cx="36" cy="12" r="6" className="fill-primary/20 stroke-primary" strokeWidth="1.5" />
        <path d="M36 10V14M34 12H38" className="stroke-primary" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    ),
  },
];
...
export default function AsuransiPropertiPage() {
  return (
    <>
      ...
      {/* ── HERO ── */}
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-950 to-primary/30 pt-24 pb-20 md:pt-32 md:pb-28">
        {/* Subtle grid texture */}
        <div
          className="pointer-events-none absolute inset-0 opacity-[0.03]"
          style={{
            backgroundImage:
              "repeating-linear-gradient(0deg, transparent, transparent 39px, hsl(var(--primary)) 39px, hsl(var(--primary)) 40px), repeating-linear-gradient(90deg, transparent, transparent 39px, hsl(var(--primary)) 39px, hsl(var(--primary)) 40px)",
          }}
        />

        {/* Glow accent kanan atas */}
        <div className="pointer-events-none absolute -top-24 -right-24 w-96 h-96 rounded-full opacity-20 bg-primary/40 blur-3xl" />
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6">
          ...
          <nav aria-label="Breadcrumb" className="mb-6">
            <ol className="flex items-center gap-2 text-sm text-white/60">
              ...
              <li aria-current="page" className="text-primary font-medium">Asuransi Properti</li>
            </ol>
          </nav>

          {/* Eyebrow */}
          <p className="inline-block text-xs font-semibold tracking-widest uppercase mb-4 px-3 py-1 rounded-full border border-primary/30 bg-primary/10 text-primary">
            Cluster Asuransi Properti
          </p>

          <h1 className="font-bold leading-tight mb-6 text-white text-4xl md:text-5xl lg:text-6xl max-w-3xl">
          ...
          <p className="text-lg leading-relaxed mb-10 text-white/80 max-w-3xl">
          ...
          <div className="flex flex-wrap gap-4">
            <a
              ...
              className="inline-flex items-center gap-2.5 bg-primary hover:bg-primary/95 text-primary-foreground font-semibold px-7 py-3.5 rounded-xl transition-all duration-200 hover:shadow-lg hover:shadow-primary/20 hover:-translate-y-0.5"
            >
            ...
            <a
              href="#produk"
              className="inline-flex items-center gap-2 font-semibold px-7 py-3.5 rounded-xl border border-white/20 text-white hover:bg-white/10 transition-all duration-200"
            >
              Lihat Produk
      ...
      <div className="bg-muted border-y border-border py-4">
        <div className="max-w-5xl mx-auto px-6">
          <p className="text-sm font-semibold text-center text-foreground/90">
      ...
      {/* ── GRID PRODUK ── */}
      <section id="produk" className="bg-background py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-16">
            <p className="text-xs font-bold tracking-widest uppercase mb-3 text-primary">
              5 Produk Utama
            </p>
            <h2 className="font-bold leading-tight text-foreground text-3xl md:text-4xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {products.map((p) => (
              ...
              >
                {/* Icon pembungkus baru */}
                <div className="inline-flex items-center justify-center w-14 h-14 rounded-xl mb-5 bg-primary/10 text-primary border border-primary/20 card-icon">
                  {p.icon}
                </div>

                {/* Subtitle */}
                <p className="text-xs font-bold uppercase tracking-wider mb-1.5 text-primary/80">
                  {p.subtitle}
                </p>

                {/* Title */}
                <h3 className="font-bold text-xl mb-3 text-foreground group-hover:text-primary transition-colors duration-200">
                  {p.title}
                </h3>
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h2 className="font-bold leading-tight mb-5 text-foreground text-3xl">
              ...
              <div className="flex flex-col gap-3.5">
                ...
                >
                  <span className="w-9 h-9 rounded-xl flex items-center justify-center bg-[#25D366] text-white shadow-sm shadow-[#25D366]/20 group-hover:scale-105 transition-transform">
                    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z" />
                    </svg>
                  </span>
            ...
            {/* Visual kartu profil modern */}
            <div className="rounded-2xl p-8 bg-slate-950 border border-slate-800 text-white shadow-xl relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-primary/10 rounded-full blur-2xl pointer-events-none" />
              <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-6 font-bold text-2xl bg-primary text-primary-foreground shadow-lg shadow-primary/20">
                R
              </div>
              <p className="text-xs font-bold tracking-widest uppercase mb-1 text-primary">
                Konsultan Asuransi Resmi
              </p>
              <h3 className="font-bold text-2xl mb-1 text-slate-100">Rio MDS</h3>
      ...
      <section className="bg-background py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="font-bold leading-tight text-foreground text-3xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              >
                <div className="w-11 h-11 rounded-xl flex items-center justify-center mb-4 bg-primary/10 text-primary">
                  {item.icon}
                </div>
      ...
      {/* ── FAQ / INSIGHT ── */}
      <section className="bg-muted/40 border-t border-border py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            <div>
              ...
              <h2 className="font-bold leading-tight text-foreground text-2xl md:text-3xl">
            ...
            <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-5">
              {[
                ...
                <div
                  key={item.q}
                  className="bg-card rounded-2xl p-5 border border-border shadow-sm hover:border-primary/20 transition-colors"
                >
      ...
      {/* ── CTA AKHIR ── */}
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 to-slate-950 py-16 md:py-24 border-t border-border">
        <div className="absolute inset-0 bg-primary/5 opacity-40 blur-3xl pointer-events-none" />
        <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
          <p className="text-xs font-bold tracking-widest uppercase mb-4 text-primary">
            Mulai Proteksi Sekarang
          </p>
          <h2 className="font-bold leading-tight mb-5 text-white text-3xl md:text-4xl lg:text-5xl">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 bg-primary hover:bg-primary/95 text-primary-foreground font-semibold px-8 py-4 rounded-xl transition-all duration-200 hover:shadow-lg hover:shadow-primary/20 hover:-translate-y-0.5"
            >
            ...
            <Link
              href="/kontak"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 font-semibold px-8 py-4 rounded-xl border border-white/20 text-white hover:bg-white/10 transition-all duration-200"
            >
